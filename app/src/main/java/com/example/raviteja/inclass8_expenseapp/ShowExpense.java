...
public class ShowExpense extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        TextView nameValue= (TextView) getActivity().findViewById(R.id.name_value);
        TextView amountValue= (TextView) getActivity().findViewById(R.id.amount_value);
        TextView categoryValue= (TextView) getActivity().findViewById(R.id.category_value);
        TextView dateValue= (TextView) getActivity().findViewById(R.id.date_value);
MainActivity activity = (MainActivity) getActivity();
        Expense expense=activity.getShowExpense();
        nameValue.setText(expense.getName());
        dateValue.setText(expense.getDate());
        amountValue.setText(String.valueOf(expense.getAmount()));
        categoryValue.setText(expense.getCategory());
        Button close = (Button) getActivity().findViewById(R.id.button);
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.returnfromShow();
            }
        });
    }
